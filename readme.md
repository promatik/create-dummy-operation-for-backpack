...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'createdummyoperation::fields',
]);
```
...
cp -i vendor/promatik/createdummyoperation/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
